...
public class GroupFileStorage {
    ...
    public static void saveGroupToSVC(Group group){
        try {
            ...
            for(int i = 0; i < group.getStudents().size(); i++){
                ...
                bufferedWriter.write(svc.toStringRepresentation(group.getStudents().get(i)));
    ...
    public static Group loadGroupFromSVC(File file){
        ...
        try {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                try{
                    group.addStudents(svc.fromStringRepresentation(line));
